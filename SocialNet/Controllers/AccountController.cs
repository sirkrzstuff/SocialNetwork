...
namespace SocialNet.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // GET: /Account/RegisterPersona
        [AllowAnonymous]
        public ActionResult RegisterPersona()
        {
            return View();
        }

        //
        // POST: /Account/RegisterPersona
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterPersona(RegisterPersonaViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
